"""
Consultas usando .order_by() para ordenar resultados
"""
...
def consultar_order_by():
    ...
    """
    print("=" * 80)
    print("CONSULTAS USANDO .order_by()")
    print("=" * 80)
    
    # Consulta 1: Instituciones ordenadas por nombre (ascendente)
    print("\n1. Instituciones ordenadas por nombre (A-Z):")
    print("-" * 80)
    ...
    print("\n2. Investigadores ordenados por apellido (A-Z):")
    print("-" * 80)
    ...
    print("\n5. Investigadores ordenados por área y luego por nombre:")
    print("-" * 80)
    ...
    print("\n6. Publicaciones ordenadas por tipo y luego por fecha (desc):")
    print("-" * 80)
